  ...
  return (
    <div className="form">
      <form action="https://formsubmit.co/f25689bdd5c4cc611301e237d5bc77eb" method="POST">
        ...
        <input type="hidden" name="_next" value={"https://formsubmit.co/f25689bdd5c4cc611301e237d5bc77eb/success"} />
        ...
        <button type="submit" className="btn" ><Link>Submit</Link></button>
      </form>
    </div>
  )
}
